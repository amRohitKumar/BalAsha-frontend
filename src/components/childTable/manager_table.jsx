...
const ManagerChildTable = ({ list, CSVDownload }) => {
  ...
  return (
    <Box sx={{ width: { xs: "95%", md: "90%" }, mt: 5 }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        <TableContainer>
          <Typography
            variant="h6"
            sx={{ mr: "1em", fontSize: "1.5em", pointer: "cursor" }}
            id="tableTitle"
            component="div"
            align="right"
          >
...
export default ManagerChildTable;
